#!/bin/bash
#SBATCH --job-name=mera_r1_math
#SBATCH --partition=a100
#SBATCH --output=math_output
#SBATCH --error=math_output.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
export MERA_FOLDER="/userspace/bak2/mera_results/api-R1-1.5B-math"
...
export MERA_COMMON_SETUP="--model openai-chat-completions --batch_size=1 --predict_only --log_samples --seed 1234 --verbosity INFO --apply_chat_template --tasks simplear,rumultiar,rumodar,mathlogicqa"

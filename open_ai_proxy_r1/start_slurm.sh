...
export MERA_MODEL_STRING="model=deepseek-ai/DeepSeek-R1-Distill-Qwen-32B,num_concurrent=8,base_url=http://localhost:8000/v1/chat/completions,tokenizer_backend=huggingface,tokenizer=deepseek-ai/DeepSeek-R1-Distill-Qwen-32B,timeout=60000"
export MERA_COMMON_SETUP="--model local-chat-completions --batch_size=auto --max_batch_size=128 --predict_only --log_samples --seed 1234 --verbosity DEBUG --apply_chat_template"

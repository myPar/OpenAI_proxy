...
export MERA_FOLDER="/userspace/bak2/mera_results/api-R1-32B"
export MERA_MODEL_STRING="model=deepseek-ai/DeepSeek-R1-Distill-Qwen-32B,num_concurrent=128,base_url=http://localhost:8000/v1/chat/completions,tokenizer_backend=huggingface,tokenizer=deepseek-ai/DeepSeek-R1-Distill-Qwen-32B,timeout=6000"
export MERA_COMMON_SETUP="--model local-chat-completions --batch_size=1 --predict_only --log_samples --seed 1234 --verbosity DEBUG --apply_chat_template --fewshot_as_multiturn"
export SYSTEM_PROMPT="Реши задачу по инструкции ниже. Не давай никаких объяснений и пояснений к своему ответу. Не пиши ничего лишнего. Пиши только то, что указано в инструкции. Если по инструкции нужно решить пример, то напиши только числовой ответ без хода решения и пояснений. Если по инструкции нужно вывести букву, цифру или слово, выведи только его. Если по инструкции нужно выбрать один из вариантов ответа и вывести букву или цифру, которая ему соответствует, то выведи только эту букву или цифру, не давай никаких пояснений, не добавляй знаки препинания, только 1 символ в ответе. Если по инструкции нужно написать код функции на языке Python - пиши только код и больше ничего, не давай пояснений, не пиши комментарии, используй только аргументы из сигнатуры функции в инструкции, не пробуй считывать данные через функцию input. Не извиняйся, не строй диалог. Выдавай только ответ и ничего больше."

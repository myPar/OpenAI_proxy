...
export MERA_MODEL_STRING="model=deepseek-ai/DeepSeek-R1-Distill-Qwen-7B,num_concurrent=64,base_url=http://localhost:8000/v1/chat/completions,tokenizer_backend=huggingface,tokenizer=deepseek-ai/DeepSeek-R1-Distill-Qwen-7B,timeout=6000"
